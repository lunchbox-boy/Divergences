...
economy = {
    ...
    TRADE_CAP_LOW_LIMIT_CONSTRUCTIONS = .05,         -- the lowest % the slider can go for constructions
...
military = {
    ...
    AI_ESCORT_RATIO = 3, -- ratio of escorts to transports in invasion fleets
