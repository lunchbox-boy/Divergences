...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.0015, -- how much foreign investment money counts towards your industry score
	UNCIV_TECH_SPREAD_MAX = 0.60, --Max techs an unciv will get on westernizing
...
economy = {
	...
	BANKRUPCY_DURATION = 2, -- Years till a bankruptcy clears all loans
	...
	FACTORY_PURCHASE_MIN_FACTOR = 1.00,			-- the lowest % of its daily needs a factory will purchase
...
military = {
	...
	AI_SUPPORT_PROPORTION = 0.0, -- fraction of brigades that should be artillery and other support units
	...
	AI_ARMY_TAXBASE_FRACTION = 0.45, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
...
ai =
{
	...
	EDUCATOR_WEIGHT = 40.0, -- ai weigth for new clergy
	...
	PEACE_ALLY_BASE_RELUCTANCE_MULT = 1.4, -- Multiplies PEACE_BASE_RELUCTANCE for allies in a war
	...
	FLEET_SIZE = 250, -- AI will attempt to keep fleets of roughly this size (fewer fleets generally results in more competent naval AI)
	...
	MAX_FLEETS = 3, -- Maximal amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
