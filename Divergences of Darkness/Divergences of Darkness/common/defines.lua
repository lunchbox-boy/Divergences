...
economy = {
    ...
    RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.8,    -- how fast pops are Hired when there is a high demand
    RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.8,    -- how fast pops are Hired when there is a medium demand
...
military = {
    ...
    AI_ESCORT_RATIO = 2, -- ratio of escorts to transports in invasion fleets
...
pops = {
    ...
    LIFE_RATING_GROWTH_BONUS = 0.000016,
...
ai =
{
    COLONY_WEIGHT = 100.0, -- ai weight for colonising
    ADMINISTRATOR_WEIGHT = 10.0, -- ai weight for new bureaucrat
    INDUSTRYWORKER_WEIGHT = 15.0, -- ai weight for new industry workers
    EDUCATOR_WEIGHT = 75.0, -- ai weigth for new clergy
    SOLDIER_WEIGHT = 45.0, -- ai weight for soldiers
    ...
    AGGRESSION_BASE = 25, -- general AI aggression
